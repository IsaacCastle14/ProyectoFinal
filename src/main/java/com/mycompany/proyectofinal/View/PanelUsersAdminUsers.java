 ...
 * @author Marco
 */
public class PanelUsersAdminUsers extends javax.swing.JPanel {
    ...
    public void setTable(String[] header, String[][] data) {
        ...
        this.tblUsersProfile.setModel(model);
        this.tblUsersProfile.setAutoCreateRowSorter(true);
        this.sorter = new TableRowSorter<>(model);
        this.tblUsersProfile.setRowSorter(sorter);
        this.jScrollPane1.setViewportView(this.tblUsersProfile);
    }
    ...
    public void ListenMouse(MouseListener controller) {
        this.tblUsersProfile.addMouseListener(controller);
    }

    public String[] getRow() {
        String[] dataRow = new String[this.tblUsersProfile.getColumnCount()];
        int selectedRow = this.tblUsersProfile.getSelectedRow();
        for (int i = 0; i < dataRow.length; i++) {
            dataRow[i] = this.tblUsersProfile.getValueAt(selectedRow, i).toString();
        }
        return dataRow;
    }
    ...
    private void initComponents() {
        ...
        tblUsersProfile = new javax.swing.JTable();
    ...
    public javax.swing.JTable tblUsersProfile;
